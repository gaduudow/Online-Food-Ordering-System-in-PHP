...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="restaurants-page">
            ...
            <a href="#" onclick="window.print()" class="btn btn-info" style="background-color: #00008B; color: white; border-radius: 2.5px; padding: 10px 17px;">
                <i class="fas fa-print"></i> <!-- This is the print icon -->
